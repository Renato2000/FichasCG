...
GLuint vertexCount, vertices, normais;
...
/*
	float cd[] = {1.0,1.0,1.0,1.0};
	float cs[] = {1.0,1.0,1.0,1.0};
...
// OpenGL settings 
	...
	glEnable(GL_LIGHT0); // a luz zero por omissão é branca, ao contrário das restantes (1-16)
