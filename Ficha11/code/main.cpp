...
void prepareCylinder(float altura, float raio, int lados) {
	...
	for (int i = 0; i < lados; ++i) {
		...
		t[vertex*2 + 0] = (0.4375 - 0.25) * sin( i * delta) + 0.4375;
		t[vertex*2 + 1] = (0.4375 - 0.25) * cos( i * delta) + 0.1875;
		...
		t[vertex*2 + 0] = (0.4375 - 0.25) * sin( (i+1) * delta) + 0.4375;
		t[vertex*2 + 1] = (0.4375 - 0.25) * cos( (i+1) * delta) + 0.1875;
		...
		v[vertex*3 + 1] = altura/2.0f;
		v[vertex*3 + 2] = raio * cos( (i+1) * delta);
		t[vertex*2 + 0] = (float) 1/lados * (i+1);
		t[vertex*2 + 1] = 1;
		...
		v[vertex*3 + 1] = -altura/2.0f;
		v[vertex*3 + 2] = raio * cos( (i+1) * delta);
		t[vertex*2 + 0] = (0.4375 - 0.25) * sin( (i+1) * delta) + 0.8125;
		t[vertex*2 + 1] = (0.4375 - 0.25) * cos( (i+1) * delta) + 0.1875;
		...
		v[vertex*3 + 1] = -altura/2.0f;
		v[vertex*3 + 2] = raio * cos( i * delta);
		t[vertex*2 + 0] = (0.4375 - 0.25) * sin( i * delta) + 0.8125;
		t[vertex*2 + 1] = (0.4375 - 0.25) * cos( i * delta) + 0.1875;
